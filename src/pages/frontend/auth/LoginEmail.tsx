        ...
        <div className="max-w-md w-full bg-card p-8 rounded-lg shadow-lg">
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-center gap-4">
              {/* Google Login */}
              <button className="bg-card rounded-xl p-4 border border-border hover:border-border transition-all duration-200 cursor-pointer group">
              ...
              <button className="bg-card rounded-xl p-4 border border-border hover:border-border transition-all duration-200 cursor-pointer group">
                <div className="flex items-center justify-center space-x-3">
                    <svg viewBox="0 0 24 24" width="20" height="20" className="fill-current text-blue-600">
