    ...
    return (
        <div>
            ...
            {[
                ...
                <div className="border-2 border-gray-200 rounded-xl p-8 flex flex-col items-center gap-2 cursor-pointer hover:border-blue-400 bg-blue-50/40 transition-colors min-h-[130px] justify-center">
